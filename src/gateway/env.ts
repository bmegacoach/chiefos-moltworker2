...
export function buildEnvVars(env: MoltbotEnv): Record<string, string> {
  ...
  // Support for Kimi / OpenAI Compatible
  if (env.KIMI_API_KEY) envVars.OPENAI_API_KEY = env.KIMI_API_KEY;
  if (env.KIMI_BASE_URL) envVars.AI_GATEWAY_BASE_URL = env.KIMI_BASE_URL;
